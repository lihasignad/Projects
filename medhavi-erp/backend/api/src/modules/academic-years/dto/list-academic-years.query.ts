...
export type AcademicYearSortField = (typeof SORTABLE_FIELDS)[number];
...
export class ListAcademicYearsQueryDto {
  ...
  @ApiPropertyOptional({
    description: 'Filter by `isCurrent` flag.',
  })
  @IsOptional()
  @Transform(({ value }) =>
  ...
  @ApiPropertyOptional({
    description: 'Include soft-deleted academic years in the result set.',
    default: false,
  })
  @IsOptional()
  @Transform(({ value }) =>
  ...
  @ApiPropertyOptional({ enum: SORTABLE_FIELDS, default: 'startDate' })
  @IsOptional()
  @IsIn(SORTABLE_FIELDS as unknown as string[])
  sortBy?: AcademicYearSortField = 'startDate';
